...
function RS_Extension(config) {
    ...
    return {
        startRecording: function(options, callback) {
            ...
            config.RS_Extension = true; // hint for background page
...
(document.head || document.body || document.documentElement).appendChild(script).text = RS_Extension.toString() + ';;';
script.remove();
